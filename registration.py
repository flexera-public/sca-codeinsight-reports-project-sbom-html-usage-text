...
import common.reports.get_reports
import common.reports.create_report
import common.reports.delete_report
import common.reports.update_report
...
def register_custom_reports():
    ...
    response = common.reports.get_reports.get_all_currently_registered_reports(baseURL, adminAuthToken)
    ...
    response = common.reports.create_report.register_report(reportName, reportPath, reportOrder, enableProjectPickerValue, reportOptions, baseURL, adminAuthToken)
...
def unregister_custom_reports():
    ...
    response = common.reports.get_reports.get_all_currently_registered_reports_by_name(baseURL, adminAuthToken, reportName)
    ...
    response = common.reports.delete_report.unregister_report_by_id(baseURL, adminAuthToken, reportId)

    if "error" in response:
        # There was an error so try via the report name
        response = common.reports.delete_report.unregister_report_by_name(baseURL, adminAuthToken, reportName)
...
def update_custom_reports():
    ...
    response = common.reports.update_report.update_custom_report(reportName, reportPath, reportID, reportOrder, enableProjectPickerValue, reportOptions, baseURL, adminAuthToken)
